...
import { Text, Flex, Button } from 'uikit-sotatek'
  ...
  return (
    <>
      ...
      <Flex flexDirection="column">
        <StyledText style={{ alignSelf: 'start' }}>{TranslateString(999, 'You Liquidity deposits')}:</StyledText>
        <Flex>
      ...
      <Flex>
        <StyledTextInfo>{TranslateString(999, 'Total USD')}: $ 1000,00000</StyledTextInfo>
      </Flex>
